...
public class MainActivity extends AppCompatActivity implements Constants {
        ...
        if (requestCode == 234) {
            ...
            if (tag) {
                ...
                try {
                    ...
                    Log.e(TAG_CLIENT, "MainActivity ===> onRequestPermissionsResult e = " + e.toString());
                }
                initMedia();
            }
        }
    ...
    private void start() {
        try {
            ...
            e.printStackTrace();
            Log.e(TAG_CLIENT, "MainActivity ===> start exception , e = " + e.getMessage());
        }
    }
...
//                            server.sendData(data);
                        ...
                        try {
                            ...
                            Log.e(TAG_CLIENT, "MainActivity ===> startRecorder e:"+e.toString());
                        }
                    }
                }
            }
    ...
    private void dealFrame(ByteBuffer bb, MediaCodec.BufferInfo bufferInfo) {
        ...
        byte[] sendData = null;
        Log.d(TAG_CLIENT, "MainActivity ===> dealFrame() , type = " + type + " , type=NAL_I = " + (type == NAL_I));
        ...
        if (sendData != null) {
            ...
            try {
                ...
                Log.e(TAG_CLIENT, "MainActivity ===> byte save to file error = " + e.toString());
            } finally {
                if (os != null) {
                    try {
                        os.close();
                    } catch (Exception e) {
                        Log.e(TAG_CLIENT, "MainActivity ===> os close error = " + e.toString());
                    }
                }
            }*/
    ...
    protected void onDestroy() {
        ...
        if (codec != null) {
            try {
                ...
                Log.e(TAG_CLIENT, "MainActivity ===> onDestroy() code e1 = " + e.toString());
            }
        }
        if (projection != null) {
            try {
                ...
                Log.e(TAG_CLIENT, "MainActivity ===> onDestroy() code e2 = " + e.toString());
            }
        }
